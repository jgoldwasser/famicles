...
describe UsersHelper do
  ...
  describe "link_to_user" do
    ...
    it "should use the email as link text with no :content_method specified" do
      link_to_user(@user).should have_tag("a", 'user@example.com')
    end
    ...
    it "should use the email as title with no :title_method specified" do
      link_to_user(@user).should have_tag("a[title='user@example.com']")
    end
  ...
  describe "link_to_current_user, When logged in" do
    ...
    it "should use the login as link text with no :content_method specified" do
      link_to_current_user().should have_tag("a", 'user@example.com')
    end
    it "should use the name as link text with :content_method => :name" do
      link_to_current_user(:content_method => :name).should have_tag("a", 'U. Surname')
    end
    it "should use the email as title with no :title_method specified" do
      link_to_current_user().should have_tag("a[title='user@example.com']")
    end
    it "should use the name as link title with :content_method => :name" do
